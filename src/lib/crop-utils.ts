/**
 * Binary cropping utility for react-easy-crop
 */
...
/**
 * Returns the rotate size of the image.
 */
...
export default async function getCroppedImg(
  ...
  // Determine mime type from data URL if possible, default to jpeg
  let mimeType = 'image/jpeg';
  if (imageSrc.startsWith('data:image/png')) mimeType = 'image/png';
  if (imageSrc.startsWith('data:image/webp')) mimeType = 'image/webp';
